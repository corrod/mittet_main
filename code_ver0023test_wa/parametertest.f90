...
module const_para
    ...
    integer :: i, j, k
    integer, parameter :: nstep = 350!291 !2500!1000 !2000 総タイムステップ数 　
    integer, parameter :: nx=121, ny=121, nz=121 !nx = 61, ny = 61, nz = 61!グリッド数 奇数　
    real(8), parameter :: dx=13.0d0,dy=dx,dz=dx!dx = 13.0d0, dy=dx, dz=dx !　
