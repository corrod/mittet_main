...
do file_num = 1010,1030,10 !file number loop
    write(file_name,*) file_num
...
!/////////////////////////////////////////////////////////////////////////////
    ...
    open(52,file='signal.d',action='read')
      nd=0
        do
    ...
    open(52,file='signal.d',action='read')
      do i=0,nd-1
          read(52,*) t2(i), inp2_r(i), inp2_i(i)
...
!       write(name,'(I3)') l  受信点位置とかがいいかも
        !ある点での周波数領域EX_w
       open(60,file='EX_w'//trim(adjustl(file_name))//'.d')
!        open(60,file='out1.dat')
        ...
        !ある点での周波数領域JZ_w
        open(61,file='JZ_w'//trim(adjustl(file_name))//'.d')
!        open(61,file='out2.dat')
        ...
        !ある点での周波数領域グリーン関数
        open(62,file='GXe_w'//trim(adjustl(file_name))//'.d')
!        open(62,file='out3.dat')
        ...
        open(70,file='absEX_w'//trim(adjustl(file_name))//'.d')
        do k=0,nd-1
        ...
        !ある点での周波数領域JZ_w
        open(71,file='absJZ_w'//trim(adjustl(file_name))//'.d')
!        open(71,file='out5.dat')
        ...
        !ある点での周波数領域グリーン関数
        open(72,file='absGXe_w'//trim(adjustl(file_name))//'.d')
...
! output
!////////////////////////////////////////////////////////////
	open(81,file='EX_t'//trim(adjustl(file_name))//'.d')
	!open(81,file='invGE.dat')
	open(82,file='JZ_t'//trim(adjustl(file_name))//'.d')
!	open(82,file='invGJ.dat')
	open(83,file='GXe_t'//trim(adjustl(file_name))//'.d')
