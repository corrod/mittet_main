...
module const_para
    ...
    integer :: i,j,k
    integer, parameter :: nstep = 1200 !2000 !総タイムステップ数
    integer, parameter :: nx = 101,ny=101,nz=101 !100, ny = 100, nz = 100 !グリッド数
    ...
    real(8), parameter :: fmax = 1000.0d0!25.0d0 !12.5kusuda!送信源の最大周波数
