...
#include "fwi3d_cpu_cpmlabc_v1.1.h"
//////////////////////////////////////////
void init_pml(){
//    int i;
...
//    int ncpml=10;
//      if(i<ncpml){
//        esigy[i] = esig_max * pow((double)(ncpml - i)/(double)ncpml, order);
//        msigy[i] = msig_max * pow((double)(ncpml - i -0.5f)/(double)ncpml, order);
//      }else if(i > (iy-ncpml) ){
//        esigy[i] = esig_max * pow((double)(i - (iy-1) + ncpml)/(double)ncpml, order);
//        msigy[i] = msig_max * pow((double)(i - (iy-1) + ncpml-0.5f)/(double)ncpml, order);
//      }else{
//        esigy[i] = 0.f;
//        msigy[i] = 0.f;
//      }
//      fprintf(fpmly,"%03d    %e   %e\n",i,esigy[i],msigy[i]);
//    }
//
//    for(i=0;i<iz;i++){
//      if(i<ncpml){
//        esigz[i] = esig_max * pow((double)(ncpml - i)/(double)ncpml, order);
//        msigz[i] = msig_max * pow((double)(ncpml - i -0.5f)/(double)ncpml, order);
//      }else if(i > (iz-ncpml) ){
//        esigz[i] = esig_max * pow((double)(i - (iz-1) + ncpml)/(double)ncpml, order);
//        msigz[i] = msig_max * pow((double)(i - (iz-1) + ncpml-0.5f)/(double)ncpml, order);
//      }else{
//        esigz[i] = 0.f;
//        msigz[i] = 0.f;
//      }
//      fprintf(fpmlz,"%03d    %e   %e\n",i,esigz[i],msigz[i]);
//    }
//    fclose(fpmlx);
//    fclose(fpmly);
//    fclose(fpmlz);
...
void init_cpml(){
    ...
    double Rcoef=0.001f; // R should be [10^-2, 10^-12]
    // compute esig_max
    ...
    double aex_max   = 0.1f; //if aex_max = 0.f, CPML changes to UPML
    double optToMax  = 0.7;
