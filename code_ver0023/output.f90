...
subroutine output_EH_J(istep,t,Je,Jh,Ex,Ey,Ez,Hx,Hy,Hz)
    ...
    write(32,*) t, real(hz(x0+2,y0,z0+8)), aimag(hz(x0+6,y0,z0+8))  !hz1010.d　
    write(33,*) t, real(hz(x0+4,y0,z0+8)), aimag(hz(x0+4,y0,z0+8))  !hz1020.d　
    write(34,*) t, real(hz(x0+6,y0,z0+8)), aimag(hz(x0+2,y0,z0+8))  !hz1030.d　
