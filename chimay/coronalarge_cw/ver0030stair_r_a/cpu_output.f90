...
subroutine output_EH_J(istep,t,Je,Jh,Ex,Ey,Ez,Hx,Hy,Hz)
    ...
    !hzレシーバー
    write(31,*) t, real(hz(xx1,y0,z_source)),    aimag(hz(xx1,y0,z_source))    !hz1000.d
    write(32,*) t, real(hz(xx1+5,y0,z_source)),  aimag(hz(xx1+5,y0,z_source))  !hz1010.d 　
    write(33,*) t, real(hz(xx1+10,y0,z_source)), aimag(hz(xx1+10,y0,z_source))  !hz1020.d 　
    write(34,*) t, real(hz(xx1+15,y0,z_source)), aimag(hz(xx1+15,y0,z_source))  !hz1030.d 　
    write(35,*) t, real(hz(xx1+20,y0,z_source)), aimag(hz(xx1+20,y0,z_source))  !hz1040.d
    write(36,*) t, real(hz(xx1+20,y0,z_source)), aimag(hz(xx1+20,y0,z_source))  !hz1050.d
    !exレシーバー
    write(20,*) t, real(ex(xx1,y0,z_source)),    aimag(ex(xx1,y0,z_source))    !ex1000.d
    write(21,*) t, real(ex(xx1+5,y0,z_source)),  aimag(ex(xx1+5,y0,z_source))  !ex1010.d 　
    write(22,*) t, real(ex(xx1+10,y0,z_source)), aimag(ex(xx1+10,y0,z_source)) !ex1020.d 　
    write(23,*) t, real(ex(xx1+15,y0,z_source)), aimag(ex(xx1+15,y0,z_source)) !ex1030.d　

    !対称性確認
    write(24,*) t, real(hz(xx1-2,y0,z_source)),  aimag(hz(xx1+2,y0,z_source))  !hzleft1.d
    write(25,*) t, real(hz(nx-11,y0,z_source)), aimag(hz(nx-11,y0,z_source)) !hzright1.d
    write(26,*) t, real(hz(xx1-5,y0,z_source)),  aimag(hz(xx1-5,y0,z_source))  !hzleft2.d
    write(27,*) t, real(hz(xx1+5,y0,z_source)),  aimag(hz(xx1+5,y0,z_source))  !hzright2.d
    write(28,*) t, real(hz(xx1-10,y0,z_source)), aimag(hz(xx1-10,y0,z_source)) !hzleft3.d
    write(29,*) t, real(hz(xx1+10,y0,z_source)), aimag(hz(xx1+10,y0,z_source)) !hzright3.d
...
! open(500,file='./out_bp/'//trim(adjustl(file_sp))//'abso2nd.d', access='append')
!     do i_rp=1+ncpml+L_hori,nx-ncpml-L_hori
!         write(500,fmt='(e22.15)') hz(i_rp,y0,plate)
!     enddo
! close(500)
...
subroutine output_EH_J_2nd(istep,t,Je,Jh,Ex,Ey,Ez,Hx,Hy,Hz)
...
!     endif
        ...
        end subroutine output_EH_J_2nd
