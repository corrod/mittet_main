...
program f_to_d_e
    ...
    real(8),allocatable :: out1(:), out2(:), out3(:)!IFFT用
...
!////////////////////////////////////////////////////////////
    call dfftw_plan_dft_c2r_1d(plan1,nd,in1,out1,FFTW_BACKWARD,FFTW_ESTIMATE) !complex array入力
    call dfftw_plan_dft_c2r_1d(plan2,nd,in2,out2,FFTW_BACKWARD,FFTW_ESTIMATE)
    call dfftw_plan_dft_c2r_1d(plan3,nd,in3,out3,FFTW_BACKWARD,FFTW_ESTIMATE)
...
!///////////////////////////////////////////////////////////
    call dfftw_execute_dft_c2r(plan1,in1,out1)
    call dfftw_execute_dft_c2r(plan2,in2,out2)
    call dfftw_execute_dft_c2r(plan3,in3,out3)
...
!         out3(n) = out3(n)/nd !GX_t
        ...
        write(81,*) n*dt, out1(n)
        write(82,*) n*dt, out2(n)
        write(83,*) n*dt, out3(n)
!         write(84,*) n*dt, out1(n)
!         write(85,*) n*dt, out2(n)
!         write(86,*) n*dt, out3(n)
    enddo
    close(81)
    close(82)
    close(83)
