...
subroutine model_simple_2
    ...
    xstart = xcenter - 2
    xend   = xcenter + 2
    ystart = ycenter - 2 + yshift2
    yend   = ycenter + 2 + yshift2
    zstart = plate - 2
    zend   = plate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_simple_2


subroutine model_simple_3
    ...
    xstart = xcenter - 2
    xend   = xcenter + 2
    ystart = ycenter - 2 + yshift3
    yend   = ycenter + 2 + yshift3
    zstart = plate - 2
    zend   = plate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_simple_3




subroutine model_simple_wide
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_simple_wide




subroutine model_simple_wide_2
    ...
    xstart = xcenter - 8
    xend   = xcenter + 8
    ystart = ycenter - 8 + yshift2
    yend   = ycenter + 8 + yshift2
    zstart = plate - 2
    zend   = plate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_simple_wide_2




subroutine model_simple_wide_3
    ...
    xstart = xcenter - 8
    xend   = xcenter + 8
    ystart = ycenter - 8 + yshift3
    yend   = ycenter + 8 + yshift3
    zstart = plate - 2
    zend   = plate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_simple_wide_3
...
subroutine model_stair_large_2
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_stair_large_2





subroutine model_stair_large_3
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_stair_large_3
...
subroutine model_pinhole8_large_2
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_pinhole8_large_2



subroutine model_pinhole8_large_3
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_pinhole8_large_3
...
subroutine model_pinholeall_large_2
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_pinholeall_large_2



subroutine model_pinholeall_large_3
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        end subroutine model_pinholeall_large_3
