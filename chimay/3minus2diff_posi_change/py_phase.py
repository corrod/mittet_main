...
# 	plt.plot(phai1[:,case])
# 	plt.grid(True)
# 	plt.title('phase of absolute %s' % str(case))
# 	savefig('./phase/%scombine_pattern_2_12_phase_onetime.png' % str(case))
# 	plt.show()
plt.show()
plt.plot(phai1[:,1400])
plt.grid(True)
plt.title('phase of absolute')
savefig('./phase/combine_pattern_2_12_phase_onetime.png')
plt.show()
...
plt.grid(True)
savefig('./phase/combine_pattern_2_23_phase_onetime.png')
plt.show()
...
plt.grid(True)
savefig('./phase/migration_abso_phase_onetime.png')
plt.show()
...
contourf(X,Y,c)
colorbar()
savefig('migration_abso_phase.png')
plt.show()
...
plt.grid(True)
savefig('./phase/migration_diff_phase_onetime.png')
plt.show()
...
xlabel('probe position')
ylabel('time')
title('phase of after migration differential')
x = arange(1,b+1)
y = arange(1,a+1)
X,Y = meshgrid(x,y)
contourf(X,Y,c)
colorbar()
savefig('migration_diff_phase.png')
plt.show()