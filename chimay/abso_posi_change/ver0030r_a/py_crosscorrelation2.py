...
np.savetxt('migration_corr_hilbert_r2.dat',y_hilbert_stac3_r)
np.savetxt('migration_corr_hilbert_i2.dat',y_hilbert_stac3_i)
np.savetxt('migration_corr_hilbert_envelope2',envelope_stac3)
...
contourf(Y,X,c)
# colorbar()
savefig('migration_corr_envelope2time.png')
show()
...
savefig('migration_corr_envelope_maxtime2timefalse.png')
show()
...
ylabel('Time',fontsize=20)
xticks([23,43,63,83], ('40', '60', '80', '100'))
savefig('migration_corr_envelope_mintime2timefalse.png')
show()
...
ylabel('Time',fontsize=20)
xticks([23,43,63,83], ('40', '60', '80', '100'))
savefig('migration_corr_envelope_maxtime2timetrue.png')
show()
...
ylabel('Time',fontsize=20)
xticks([23,43,63,83], ('40', '60', '80', '100'))
savefig('migration_corr_envelope_mintime2timetrue.png')
show()
