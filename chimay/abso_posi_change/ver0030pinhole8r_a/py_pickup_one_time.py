...
ax3.plot([20,20],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([30,30],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([39,39],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([41,41],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([53,53],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([57,57],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([67,67],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([73,73],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([93,93],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot([107,107],[0,4e-7], color='red', linewidth=1, linestyle="--")
ax3.plot(rp,one_data,color='blue',label='abso' )
ax3.grid(True)
ax3.legend()
