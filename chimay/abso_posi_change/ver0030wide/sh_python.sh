...
#derivation of combine_pattern or combine_residual_
# python py_derivation.py

# #hilbert transform of migration bad bad bad
# py_hilbert.py bad bad bad

# migration backpropagate residual
# py_migration.py

# # derivation of migrated residual
# py_migration_derivation.py

# # hilbert transform of migrated residual
# py_migration_hilbert.py
