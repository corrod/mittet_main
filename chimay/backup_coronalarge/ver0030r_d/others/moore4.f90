...
module mod_matrix
   ...
   real(8),parameter :: t=1.14315354400754132d-3,f=0.21356765788794985
   integer :: m,n
   complex(kind(0d0)) :: a(mm,nn),b(mm),c(mm),d(mm)
end module
...
!   read(10,*) m,n
  ...
  ! b を読む
!   open(10,file='Ef4_jointtest2a')
   open(10,file='Ef4joint_wn13_11a')
   do i=1,m
      read(10,*) d(i)
   end do
   close(10)

!   open(11,file='dif4_mat6_11a')
!   do i=1,m
!      read(11,*) c(i)
!   end do
!   close(11)

  open(12,file='readdata')
   do i=1,m
      if (i.le.500) then
      b(i)=d(i)
      else
!      b(i)=c(i)
      ...
      write(12,*) i-1,(i-1)*f,abs(b(i)),real(b(i)),aimag(b(i))
   end do
...
!   stop
 ...
 !  open(11,file="cond_t7_11t13.dat")
   ...
   open(15,file='fic4joint2_wn13_6.dat')
   do i=1,n
