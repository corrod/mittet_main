...
module const_para
    ...
    real(8), parameter :: dx = 100.0d0, dy=dx, dz=dx!9.0d-3,dy=9.0d-3,dz=9.0d-3 !1.100d-4, dy = 1.100d-4, dz = 1.100d-4 !　　　101,51,41
    real(8), parameter :: dt = 1.870d-6!3.00d-7 !タイムステップ長 s 　　　
    real(8), parameter :: fmax = 1.0d0!1.0d2 !25.0d0 !12.5kusuda!送信源の最大周波数 　　　
...
!conductivity 導電率
    ...
    real(8), parameter :: sigfe  = 1.0d0! 　　　7.5d6  !1.03d7 !鉄の導電率 S/m
    real(8), parameter :: sigwa  = 1.0d0d0  !海水の導電率 S/m
